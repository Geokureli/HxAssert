...
class AssertLogger {
	...
	inline public function floatEquals(value:Float, expected:Float, approx:Float, ?msg:String, ?pos:PosInfos):Bool {
	...
	function compareFloats(value:Float, expected:Float = 0, approx:Float):Bool {
	...
	inline public function contains<T>(list:Array<T>, item:T, ?msg:String, ?pos:PosInfos):Bool {
